...
@EntityScan(basePackages = "br.com.egotting.simple_api_restful_springboot.domain.Entity")
public class JpaConfig {
    ...
    @Bean
    PlatformTransactionManager transactionManager(EntityManagerFactory entityFactoryManager) {
