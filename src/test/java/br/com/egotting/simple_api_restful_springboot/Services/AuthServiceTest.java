...
import br.com.egotting.simple_api_restful_springboot.domain.Services.Auth.AuthServices;
...
public class AuthServiceTest {
    ...
    public void testLoginUser() {
        ...
        var user = new User("user1@example.com", Arrays.asList(NameRoles.USER).toString());
        user.setEmail(email);
